...
export default function Services() {
  ...
  const data = [
    ...
    },
    {
      ...
      title: "Branding",
      text:
        "After analyzing the market, the product/service and vision of investors we start to conceptualize the brand name and the detailed implementation strategies in the market. ",
      value: "brand",
    },
    {
      src: "logo3.png",
      title: "Support",
      text:
        "Your web site standard maintenance will have up-to-date information, back up service, speed and continuous performance monitoring.",
      value: "support",
    },
  ];
  return (
